...
abstract class AppLocalizations {
  ...
  /// No description provided for @summaryUploadFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to upload summary image'**
  String get summaryUploadFailed;
  ...
  /// No description provided for @onboardingOcrTitle.
  ///
  /// In en, this message translates to:
  /// **'Set Up Document OCR'**
  String get onboardingOcrTitle;

  /// No description provided for @onboardingOcrBody.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @onboardingOcrGuide.
  ///
  /// In en, this message translates to:
  /// **'Go to Settings'**
  String get onboardingOcrGuide;

  /// No description provided for @onboardingToolsHint.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @onboardingAiGuide.
  ///
  /// In en, this message translates to:
  /// **'Set Up Models'**
  String get onboardingAiGuide;

  /// No description provided for @onboardingExpertHint.
  ///
  /// In en, this message translates to:
  /// **'Configure a multimodal model for in-document chat and OCR proofreading'**
  String get onboardingExpertHint;

  /// No description provided for @onboardingFastHint.
  ///
  /// In en, this message translates to:
  /// **'Configure a fast model for translation, quick Q&A, and title renaming'**
  String get onboardingFastHint;

  /// No description provided for @onboardingImageGenHint.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @emptyLibraryAction.
  ///
  /// In en, this message translates to:
  /// **'Initial Setup'**
